...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.classifiersResponse"
                        }
                    }
                }
            },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/notmuch.EmailContentResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.associateTripEmailResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "additionalProperties": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/handlers.tripResponse"
                                }
                            }
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.createTripRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.tripEmailsResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "handlers.associateTripEmailResponse": {
            "type": "object",
            "properties": {
                "message_id": {
                    "type": "string",
        ...
        "handlers.classifierCategoryJSON": {
            "type": "object",
            "properties": {
                "domains": {
                    "type": "array",
        ...
        "handlers.classifiersResponse": {
            "type": "object",
            "properties": {
                "categories": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/handlers.classifierCategoryJSON"
                    }
                }
            }
        },
        "handlers.createTripRequest": {
            "type": "object",
            "properties": {
                "date_range": {
                    "type": "string"
        ...
        "handlers.tripEmailsResponse": {
            "type": "object",
            "properties": {
                "emails": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.TripEmailItem"
                    }
                },
                "trip_id": {
                    "type": "string",
